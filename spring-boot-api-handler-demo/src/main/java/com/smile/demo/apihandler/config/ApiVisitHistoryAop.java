...
import com.smile.demo.apihandler.utils.AtomicCounter;
...
@Aspect
@Slf4j
public class ApiVisitHistoryAop {
    ...
    /**
     * 定义切面
     * - 此处代表com.smile.demo.apihandler.controller包下的所有接口都会被统计
     */
    @Pointcut("execution(* com.smile.demo.apihandler.controller..*.*(..))")
